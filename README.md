...
- **Ferramentas Principais:** VS Code, IntelliJ IDEA, Postman, DBeaver, Docker Desktop, MongaDB.
- **Itens Raros:**
...
- **Missões Concluídas:**
    - Estudar inglês mais de 95% dos dias de 2024.
    - Não deixar de estudar programação.

<br />

## 🎯 Quests em Progresso

- Criar novos projetos para praticar.
- Terminar o curso de Angular - 72% concluído.
- Terminar o curso de Golang - 60% concluído.
- Começar o curso de Vue.js.
- Começar o curso de Testes.
...
- **Grimório LinkedIn:** [phyllipesa](https://www.linkedin.com/in/phyllipesa/ "phyllipesa")
